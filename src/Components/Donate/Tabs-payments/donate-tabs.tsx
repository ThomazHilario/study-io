    ...
    return(
        <Tabs.Root className='mt-6' defaultValue='pix'>
            <Tabs.List className='flex gap-5 mb-5'>
                <Tabs.Trigger role='btn-tabs-pix' value='pix' className={tabsTriggerCss}>Pix</Tabs.Trigger>
                <Tabs.Trigger role='btn-tabs-paypal' value='paypal' className={tabsTriggerCss}>PayPal</Tabs.Trigger>
            </Tabs.List>

            <Tabs.Content role='content-pix' className='flex justify-center items-center' value='pix'>
            ...
            <Tabs.Content role='content-paypal' className='flex justify-center items-center text-2xl' value='paypal'>
