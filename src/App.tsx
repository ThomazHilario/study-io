...
appWindow.onResized(() => {
  ...
  const timerDrag =
    localStorage.getItem("timerDrag") !== null &&
    JSON.parse(localStorage.getItem("timerDrag") as string);
  ...
  const TaskFrameDrag =
    localStorage.getItem("TaskFrameDrag") !== null &&
    JSON.parse(localStorage.getItem("TaskFrameDrag") as string);
