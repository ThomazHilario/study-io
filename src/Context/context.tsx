...
export const UserData = ({children}:ChildrenType) => {
    ...
    return(
        <Context.Provider value={{isFullscreen, setIsFullscreen, resizable, setResizable, isTask, setIsTask, isNotes, setIsNotes, isTimer, setIsTimer, isThemes, setIsThemes}}>
            {children}
        </Context.Provider>
    )
}
